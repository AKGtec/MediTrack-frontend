          ...
          <div class="logo-container">
            <div class="logo-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <path d="M12 11.5C13.933 11.5 15.5 12.5 15.5 15.5C15.5 18.5 12 20.5 12 20.5C12 20.5 8.5 18.5 8.5 15.5C8.5 12.5 10.067 11.5 12 11.5Z"/>
                <path d="M16 7.5C16 9.70914 14.2091 11.5 12 11.5C9.79086 11.5 8 9.70914 8 7.5"/>
                <path d="M15.5 15.5C15.5 18.5 12 20.5 12 20.5"/>
                <path d="M8.5 15.5C8.5 18.5 12 20.5 12 20.5"/>
              </svg>
            </div>

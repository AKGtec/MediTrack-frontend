...
@Component({
    ...
    <div class="layout">
      <aside class="sidebar">
        ...
        <nav class="nav">
          ...
          <a routerLink="/appointments/booking" routerLinkActive="active">
            <i class="icon">add_circle</i>
            <span>Book Appointment</span>
          </a>
          <a routerLink="/patients/ehr" routerLinkActive="active">
            <i class="icon">medical_information</i>
            <span>My EHR</span>
          </a>
          <a routerLink="/patients/profile" routerLinkActive="active">
  ...
  styles: [`
    ...
    .sidebar { width: 240px; background: #111827; color: #e5e7eb; display: flex; flex-direction: column; padding: 1rem; }

    ...
    <div class="layout">
      ...
      <aside class="sidebar">
        ...
        <div class="brand">
          <div class="logo-container">
            ...
            <div class="brand-text">
              ...
              <span class="role">Patient Portal</span>
            </div>
          </div>
        </div>
        ...
        <nav class="nav">
          ...
          <a routerLink="/patient/appointments/booking" routerLinkActive="active" class="nav-item">
            <div class="nav-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a routerLink="/patient/patients/appointments" routerLinkActive="active" class="nav-item">
            <div class="nav-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a routerLink="/patient/patients/ehr" routerLinkActive="active" class="nav-item">
            <div class="nav-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="nav-text">My EHR</span>
            <div class="nav-indicator"></div>
          </a>
